local site_config = {}
site_config.LUAROCKS_PREFIX=[[/root/virus/.luarocks]]
...
site_config.LUAROCKS_SYSCONFDIR=[[/root/virus/.luarocks/luarocks]]
site_config.LUAROCKS_ROCKS_TREE=[[/root/virus/.luarocks]]
